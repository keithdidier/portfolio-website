        ...
        <section id="about-wrapper">
          <div className="about">
            ...
            <div className="bio">
              ...
              <div className="social-links">
                <a
                  href="https://www.linkedin.com/in/keithdidier/"
                  target="_blank"
                >
                  <i className="fa fa-linkedin fa-lg" aria-hidden="true" />
                </a>
                <a href="https://github.com/keithdidier" target="_blank">
                  <i className="fa fa-github fa-lg" aria-hidden="true" />
                </a>
              </div>
              <p>
                I'm a full stack web developer with a passion for front-end
                development. My focus is on building mobile responsive websites
                and web apps using technologies such as React, Angular and
                Node.js. I keep my skills sharp by coding daily and learning
                top-notch frameworks and libraries.
              </p>
          ...
          <section className="technology">
            ...
            <div className="skills-grid">
              ...
              <div className="skills-column">
                <img src={javascriptLogo} alt="" className="javascript-logo" />
                <li>JavaScript</li>
              </div>
              <div className="skills-column">
                <img src={mysqlLogo} alt="" className="mysql-logo" />
                <li>MySQL</li>
              </div>
              <div className="skills-column">
                <img src={bootstrapLogo} alt="" className="bootstrap-logo" />
                <li>Bootstrap</li>
              </div>
              <div className="skills-column">
